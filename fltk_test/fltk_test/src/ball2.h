...
// function used to start the ball movement if the smart movement is not on
...
// function that is not implemented because my laptop could not handle the trigonometirc functions
void angle_calculate(){
	/*     int a= this->speedX;
		   ...
		   double beta = 90-alfa;
	       double degrees=beta;
		degrees-=22.5;  // or +22.5 if on the other side
		double tangens=tan(degrees);
		this->speedX= b/tangens;
		*/
}
